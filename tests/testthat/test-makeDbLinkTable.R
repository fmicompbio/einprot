test_that("making the link table works", {
    ...
    expect_equal(.makeLinkFromId("Q7YTG1-1", "BioGRID", removeSuffix = TRUE),
                 '<a href="https://thebiogrid.org/search.php?search=Q7YTG1&organism=all" target="_blank"> Q7YTG1</a>')
    expect_equal(.makeLinkFromId("Q7YTG1-1", "BioGRID", removeSuffix = FALSE),
                 '<a href="https://thebiogrid.org/search.php?search=Q7YTG1-1&organism=all" target="_blank"> Q7YTG1-1</a>')
    ...
    expect_equal(dblt$ComplexPortal, c(
        ...
        '<a href="https://www.ebi.ac.uk/complexportal/complex/search?query=B5BP45" target="_blank"> B5BP45</a>'),
        ignore_attr = TRUE)
    expect_equal(dblt$BioGRID, c(
        '<a href="https://thebiogrid.org/search.php?search=B5BP45&organism=all" target="_blank"> B5BP45</a>',
        '<a href="https://thebiogrid.org/search.php?search=O13282&organism=all" target="_blank"> O13282</a>',
        '<a href="https://thebiogrid.org/search.php?search=B5BP45&organism=all" target="_blank"> B5BP45</a>'),
        ignore_attr = TRUE)
    ...
    expect_equal(ncol(dblt2), 6)
    expect_equal(nrow(dblt2), 2)
    expect_named(dblt2, c("id", "UniProt", "AlphaFold", "ComplexPortal",
                          "BioGRID", "PomBase"))
    ...
    expect_equal(dblt4$ComplexPortal, c(
        ...
        ignore_attr = TRUE)
    expect_equal(dblt4$BioGRID, c(
        '<a href=\"https://thebiogrid.org/search.php?search=Q7YTG1&organism=all\" target=\"_blank\"> Q7YTG1</a>;<a href=\"https://thebiogrid.org/search.php?search=O18250&organism=all\" target=\"_blank\"> O18250</a>',
        '<a href=\"https://thebiogrid.org/search.php?search=C1P641&organism=all\" target=\"_blank\"> C1P641</a>;<a href=\"https://thebiogrid.org/search.php?search=C1P640&organism=all\" target=\"_blank\"> C1P640</a>'),
        ignore_attr = TRUE)
    ...
    expect_equal(grep(";", dblt5$BioGRID), c(1, 2))
    ...
    expect_equal(dblt5$BioGRID, dblt4$BioGRID)
    ...
    expect_equal(dblt6$BioGRID, dblt4$BioGRID)
    ...
    expect_equal(dblt7$BioGRID, dblt4$BioGRID)
