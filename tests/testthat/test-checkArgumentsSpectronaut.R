test_that("argument checking for Spectronaut works", {
    ## Working arguments
    args0 <- list(
    ...
    expect_null(do.call(.checkArgumentsSpectronaut, args0))
    ...
    args <- args0
    args$species <- 1
    expect_warning(do.call(.checkArgumentsSpectronaut, args),
                   "Unknown species 1")
