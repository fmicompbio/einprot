...
runSEAnalysis <- function(
        ...
        idCol, labelCol = idCol, geneIdCol = NULL, proteinIdCol = NULL, stringIdCol = NULL,
        extraFeatureCols = NULL, filtersSE = list(), imputeMethod = "MinProb",
    ...
    .checkArgumentsSE(
        ...
        imputeMethod = imputeMethod, imputeArgs = imputeArgs,
