...
filtdf <- as.data.frame(rowData(sce)) %>%
    dplyr::select(Potential.contaminant, 
                  Combined.Total.Peptides) %>%
    dplyr::mutate(across(c(Potential.contaminant), 
                         function(x) as.numeric(x == "+"))) %>%
    dplyr::mutate(Combined.Total.Peptides = as.numeric((Combined.Total.Peptides < minPeptides)|is.na(Combined.Total.Peptides)))
