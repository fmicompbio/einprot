...
links to external resources, and additional global overviews 
of the data are provided via [principal component analysis](#run-pca) and 
[summary heatmaps](#heatmap-with-hierarchical-clustering).
...
The box plot below displays the distribution of values in the input assay 
defined above in each sample, on a log scale (excluding any missing values).
...
<details>
<summary><b>
Click to see examples of the defined feature identifiers remaining after the filtering
</b></summary>
...
testres <- runTest(sce = sce, comparisons = comparisonList$comparisons,
                   ...
                   baselineGroup = baselineGroup, 
                   extraColumns = interactiveDisplayColumns)
