...
makeTableFromList(readMaxQuantXML(mqParameterFile))
```
...
```{r get-icols-all}
ics <- getIntensityColumns(mqFile = mqFile, iColPattern = iColPattern,
...
```{r read-data}
## Read MaxQuant output
qft <- QFeatures::readQFeatures(mqFile, ecol = ics$iCols, name = aName, 
                                sep = "\t")
...
makeIntensityBoxplots(qft = qft, aName = aName, doLog = TRUE, 
                      ylab = "Raw intensity")
```
...
makeIntensityBoxplots(qft = qft, aName = paste0("log2_", aName),
                      doLog = FALSE, 
...
makeMeanSDPlot(qft = qft, aName = paste0("log2_", aName),
...
makeIntensityBoxplots(qft = qft, aName = paste0("log2norm_", aName),
                      doLog = FALSE, 
                      ylab = "log2 intensity (after imputation and normalization)")

makeMeanSDPlot(qft = qft, aName = paste0("log2norm_", aName), 
