...
the first annotated `r ifelse(primaryIdType == "gene", "gene name", "protein ID")`, 
or, in cases where that is missing, with 
the first annotated `r ifelse(primaryIdType == "gene", "majority protein ID", "gene name")`. 
When this doesn't uniquely identify the feature, it is combined with the 
`r ifelse(primaryIdType == "gene", "majority protein ID", "gene name")` to generate 
