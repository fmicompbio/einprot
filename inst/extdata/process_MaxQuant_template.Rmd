...
for (cmp in comparisons) {
    outres <- runTest(qft = qft, comparison = cmp, testType = stattest, 
                      ...
                      volcanoS0 = volcanoS0, aName = aName)
...
```{r make-sce}
sce <- assembleSCE(qft = qft, aName = aName, all_tests = all_tests, 
                   iColPattern = iColPattern, iColsAll = iColsAll, 
                   baseFileName = sub("\\.Rmd$", "", knitr::current_input()), 
                   nbr_na = nbr_na, featureCollections = featureCollections)
