...
This report describes a reproducible end-to-end analysis of a proteomics dataset 
quantified with [MaxQuant](https://www.maxquant.org/) [@Cox2008maxquant]. 
...
for (a in unique(c(aNames$assayImputed, aNames$assayBatchCorr))) {
    ...
    interactivePCAs[[a]] <- ggplotly(p, width = 750, height = 500)
}
```
